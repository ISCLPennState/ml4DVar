...
if __name__ == '__main__':
    ...
    for psi in pred_start_idxs:
        ...
        np.save(os.path.join(save_dir,'sh_scalarUV_{}hrGTNMC_{:0>2d}.npy'.format(hour_diff,6*psi)), sh_var_norm)
        np.save(os.path.join(save_dir,'hf_scalarUV_{}hrGTNMC_{:0>2d}.npy'.format(hour_diff,6*psi)), hf_var_norm)