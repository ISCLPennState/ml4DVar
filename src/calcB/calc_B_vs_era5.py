...
if __name__ == '__main__':
    ...
    for psi in pred_start_idxs:
        ...
        for i in range(0,len(files_norm)):
            ...
            # diff_norm_scalar = diff_norm[nowind_idxs]
            # diff_norm_u = diff_norm[uwind_idxs]
            # diff_norm_v = diff_norm[vwind_idxs]
            # diff_norm_vector = torch.stack((diff_norm_u,diff_norm_v),axis=??)
            # sh_diff_norm_scalar = sht(diff_norm_scalar)
            # sh_diff_norm_vector = v_sht(diff_norm_scalar)
