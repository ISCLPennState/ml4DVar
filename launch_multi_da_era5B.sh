...
python run_da_era5.py $da_type "var3d_era5B_era5Obs_Jan15_gpu0" 0 & ;
python run_da_era5.py $da_type "var3d_era5B_era5Obs_Jan15_gpu1" 1 & ;
python run_da_era5.py $da_type "var3d_NMC12hrB_era5Obs_Jan15" 2 & ;
python run_da_era5.py $da_type "var3d_NMC24hrB_era5Obs_Jan15" 3 ;